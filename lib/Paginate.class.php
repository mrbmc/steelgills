...
{ 
	...
	function __construct($_page=0,$_pagesize=0) {
		$this->page = isset(Dispatcher::instance()->params['p']) ? $this->clean(Dispatcher::instance()->params['p']) : $this->page;
		$this->perpage = isset(Dispatcher::instance()->params['perpage']) ? $this->clean(Dispatcher::instance()->params['perpage']) : $this->perpage;
	}
